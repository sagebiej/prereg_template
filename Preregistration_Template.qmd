...
##  Which socio-demographic and other case-specific variables do you need to test your hypotheses?

*Case-specific variables are variables that do not vary between alternatives but vary accross respondents. These variabels could include all variables that you plan to integrate into your utility function, including dummies for split samples. If not applicable, leave blank.*

::: {.content-visible when-profile="answers"}
We need the treatment dummies to test H5. We need the respondent’s city and socio-demographic variables like age, gender, income, and household size to test H3. These variables were integrated into the design by collecting them through the survey and using them in the analysis phase.
:::
...
::: {.content-visible when-profile="answers"}
Yes, the sample is split into three groups to test the effect of different information treatments on respondent choices.
:::
...
## Which discrete choice models do you plan to estimate?
...
Screenshot of choice sets: Yes\
Link to questionnaire or questionnaire pdf: Yes\
Code for simulation: No
:::

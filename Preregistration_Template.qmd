...
*When you do your design with a specific software (NGENE, `spdesign` in R etc.), describe all assumptions (utility specification, optimization routine etc.). See for example @scarpa2008design for reporting guidelines of efficient designs.*
...
*Monte-Carlo simulations are a good way to test the design for unbiasedness, power and efficiency, and can help you to justify your design choice. In R you can use* `simulateDCE` [@simdce]. *If you did not use simulation, describe how you decided for the design you choose and what other designs you have compared it to.*

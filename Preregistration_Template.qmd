...
*Briefly but precisely state all research questions and hypotheses of this study.*
...
*You can use a table here. In cases that the number of alternatives varied, or that you used different split samples for different attributes, elaborate this here.*
...
##  How did you code your attributes
...
*Do you use a utility maximisation framework? Which coding for your attribute levels do you plan to use? How do you specify interaction variables? Do you use non-linear specifications of some attributes (e.g. logarithm, quadratic)?*
...
*When you do your design with a specific software (NGENE, `spdesign` in R etc.), describe all assumptions (utility specification, optimization routine etc.)*
...
*Some researchers use small priors indicating the sign of the parameters, others use priors based on assumptions or previous studies. Be concise and transparent which ones you use.*
...
*In most cases, it is recommended to randomize the order of choice sets, alternatives and attributes to avoid undesired effects (e.g. left right bias). Note down if you do this, or if you do not do this, explain why not.*
...
*Quickly state if you use an opt-out or status quo alternative as an alternative is your choice set. If you do not use any, you can state that you use a forced choice experiment.*
...
## 24. Describe your estimation strategy and any software used:
...
## Which discrete choice models do you plan to estimate? If you consider multiple models, specify your preferred specification or model averaging approach (e.g. but not limited to policy recommendations, welfare measures, methodical questions).
...
::: {.content-visible when-profile="answers"}
We rely on random utility theory and will estimate random parameters logit models, conditional logit models, and latent class logit models.
:::
...
*Most applications control for bot unobserved heterogeneity via mixed logit or latent class models and for observed heterogeneity via interation terms between attributes and alternative-specific constants and case-specific variables such as age or gender. List how you plan to deal with heterogeneity.*
...
::: {.content-visible when-profile="answers"}
Questions on perceived consequentiality.
:::
...
*In surveys, often some datapoints are missing, e.g. if respondents do not answer a specific question. One can exclude such respondents or use imputation methods. Explain your strategy. *
...
## Anything else you want to preregister:
...
Screenshot of choice sets: 
Link to questionnaire or questionnaire pdf: 
Code for simulation:
